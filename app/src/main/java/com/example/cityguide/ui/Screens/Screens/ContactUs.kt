    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                ContactItem(icon = Icons.Default.AccountCircle, text = "Name: Aparna Suman Jha")

                Spacer(modifier = Modifier.padding(vertical = 2.dp))

                ContactItem(icon = Icons.Default.Email, text = "Email: aparna@gmail.com")

                Spacer(modifier = Modifier.padding(vertical = 2.dp))

                ContactItem(icon = Icons.Default.Phone, text = "Phone: +91 70280 31315")
